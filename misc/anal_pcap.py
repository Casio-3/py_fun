...
for line in data:
    ...
    # Get the target ASCII in Sqli sentences
    ...
    # To deal with the situation that all http status code is '200' in Blind Sqli, in which we should hold the right
    # results For the giving example, we find 2 different response Content-Length:332 & 366
